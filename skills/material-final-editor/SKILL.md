...
1. Identify the target reader, document type, and confirmed sections.
2. Preserve binding template structure, section order, numbering, and required fields.
3. Remove or rewrite stale claims, unsupported carryover, and process leaks.
4. Keep concrete project facts, responsibilities, and captions aligned with the current project.
5. Leave any unresolved or missing content explicit rather than invented.
